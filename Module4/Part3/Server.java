...
public class Server {
    int port = 3001;
    // connected clients
    private List<ServerThread> clients = new ArrayList<ServerThread>();     //An "ArrayList" is used because the maximum connections is undetermined, if a maximum is determined then an "Array" is used instead.
